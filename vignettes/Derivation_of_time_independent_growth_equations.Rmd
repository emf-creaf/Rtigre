...
To specify the dependence of growth on a given set of explanatory variables, which we will hereafter denote as $\mathcal{X}$, like e.g. climate, landscape, competition, we will implement an implicit growth rate parameter $k$:
